            ...
            <div id="home" className="landing-wrapper overflow-hidden">
                <div className="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center justify-content-between relative lg:static">
                    <Link href="/" className="flex align-items-center">
                        <img src={`${contextPath}/layout/images/${layoutConfig.colorScheme === 'light' ? 'logo-dark' : 'logo-white'}.svg`} alt="SICOP Logo" height="50" className="mr-0 lg:mr-2" />
                        <span className="text-900 font-medium text-2xl line-height-3 mr-8">SICOP</span>
                    </Link>
                    ...
                    <div className="align-items-center surface-0 flex-grow-1 justify-content-between hidden lg:flex absolute lg:static w-full left-0 px-6 lg:px-0 z-2" style={{ top: '100%' }}>
                        ...
                        <div className="flex justify-content-between lg:block border-top-1 lg:border-top-none surface-border py-3 lg:py-0 mt-3 lg:mt-0">
                            <Button label="Logar" text rounded className="border-none font-light line-height-2 text-blue-500"></Button>
                            <Button label="Registrar" rounded className="border-none ml-5 font-light line-height-2 bg-blue-500 text-white"></Button>
                        </div>
                    </div>
                </div>
                ...
                <div id="features" className="py-4 px-4 lg:px-8 mt-5 mx-0 lg:mx-8">
                    <div className="grid justify-content-center">
                        <div className="col-12 text-center mt-8 mb-4">
                            <h2 className="text-900 font-normal mb-2">Características Incríveis</h2>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <h5 className="mb-2 text-900">Fácil de Utiizar</h5>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <h5 className="mb-2 text-900">Desgin Renovado</h5>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <h5 className="mb-2 text-900">Código Limpo</h5>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pb-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <h5 className="mb-2 text-900">Modo Escuro</h5>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <h5 className="mb-2 text-900">Práticas Modernas</h5>
                ...
                <div id="highlights" className="py-4 px-4 lg:px-8 mx-0 my-6 lg:mx-8">
                    <div className="text-center">
                        <h2 className="text-900 font-normal mb-2">Poderoso em todo lugar</h2>
